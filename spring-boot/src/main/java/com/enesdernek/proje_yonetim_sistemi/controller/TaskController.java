...
public class TaskController {
	...
	@PreAuthorize("isAuthenticated()")
	public ResponseEntity<SuccessDataResult<TaskDto>> changeTaskStatus(Authentication auth, Long taskId,
			TaskStatus taskStatus) {
		User user = (User) auth.getPrincipal();
		Long authUserId = user.getUserId();

		SuccessDataResult<TaskDto> result = new SuccessDataResult<>(
				this.taskService.changeTaskStatus(authUserId, taskId, taskStatus), "Görev başarıyla güncellendi.");
	...
	public ResponseEntity<SuccessDataResult<TaskDto>> changeTaskStatusToDone(Authentication auth, Long taskId) {
		...
		SuccessDataResult<TaskDto> result = new SuccessDataResult<>(
				this.taskService.changeTaskStatusToDone(authUserId, taskId), "Görev başarıyla tamamlandı.");
	...
	public ResponseEntity<SuccessDataResult<TaskDto>> changeTaskStatusToInProgress(Authentication auth, Long taskId) {
		...
		SuccessDataResult<TaskDto> result = new SuccessDataResult<>(
				this.taskService.changeTaskStatusToInProgress(authUserId, taskId), "Görev başarıyla güncellendi.");
	...
	public ResponseEntity<SuccessDataResult<TaskDto>> changeTaskStatusToReview(Authentication auth, Long taskId) {
		...
		SuccessDataResult<TaskDto> result = new SuccessDataResult<>(
				this.taskService.changeTaskStatusToReview(authUserId, taskId), "Görev başarıyla güncellendi.");
	...
	@PreAuthorize("isAuthenticated()")
	public ResponseEntity<SuccessDataResult<TaskDto>> updateTask(Authentication auth, Long taskId,
			@Valid @RequestBody TaskDtoIU taskDtoIU) {
		User user = (User) auth.getPrincipal();
		Long authUserId = user.getUserId();

		SuccessDataResult<TaskDto> result = new SuccessDataResult<>(
				this.taskService.updateTask(authUserId, taskId, taskDtoIU), "Görev başarıyla güncellendi.");
	...
	@PreAuthorize("isAuthenticated()")
	public ResponseEntity<SuccessDataResult<TaskDtoPagedResponse>> getAllProjectTasksByStatus(Authentication auth,
			Long projectId, TaskStatus status, int pageNo, int pageSize) {

		User user = (User) auth.getPrincipal();
		Long authUserId = user.getUserId();

		SuccessDataResult<TaskDtoPagedResponse> result = new SuccessDataResult<>(
				this.taskService.getAllProjectTasksByStatus(authUserId, projectId, status, pageNo, pageSize),
	...
	@PreAuthorize("isAuthenticated()")
	public ResponseEntity<SuccessDataResult<TaskDtoPagedResponse>> getUsersAllTasks(Authentication auth, int pageNo,
			int pageSize) {
		User user = (User) auth.getPrincipal();
		Long authUserId = user.getUserId();

		SuccessDataResult<TaskDtoPagedResponse> result = new SuccessDataResult<>(
				this.taskService.getUsersAllTasks(authUserId, pageNo, pageSize), "Görevler başarıyla getirildi");
	...
	@PreAuthorize("isAuthenticated()")
	public ResponseEntity<SuccessDataResult<TaskDto>> createTask(Authentication auth,
			@Valid @RequestBody TaskDtoIU taskDtoIU) {
	...
	@PreAuthorize("isAuthenticated()")
	public ResponseEntity<SuccessDataResult<TaskDtoPagedResponse>> getAllProjectMembersTasksByProject(
			Authentication auth, Long assignedMemberId, Long projectId, int pageNo, int pageSize) {
		User user = (User) auth.getPrincipal();
		Long authUserId = user.getUserId();

		SuccessDataResult<TaskDtoPagedResponse> result = new SuccessDataResult<>(this.taskService
				.getAllProjectMembersTaskByProject(authUserId, assignedMemberId, projectId, pageNo, pageSize),
				"Görevler başarıyla getirildi");
	...
	@PreAuthorize("isAuthenticated()")
	public ResponseEntity<SuccessDataResult<TaskDtoPagedResponse>> getAllUsersTasksByStatus(Authentication auth,
			TaskStatus status, int pageNo, int pageSize) {
		User user = (User) auth.getPrincipal();
		Long authUserId = user.getUserId();
	...
	@GetMapping("/get-all-users-tasks-by-project")
	@PreAuthorize("isAuthenticated()")
	public ResponseEntity<SuccessDataResult<TaskDtoPagedResponse>> getAllUsersTasksByProjectId(Authentication auth,
			Long projectId, int pageNo, int pageSize) {
		User user = (User) auth.getPrincipal();
		Long authUserId = user.getUserId();

		SuccessDataResult<TaskDtoPagedResponse> result = new SuccessDataResult<>(
				this.taskService.getAllUsersTasksByProjectId(authUserId, projectId, pageNo, pageSize),
				"Kullanıcının projedeki görevleri başarıyla getirildi.");

		return new ResponseEntity<>(result, HttpStatus.OK);
	}

	@GetMapping("/get-all-users-tasks-by-project-and-status")
	@PreAuthorize("isAuthenticated()")
	public ResponseEntity<SuccessDataResult<TaskDtoPagedResponse>> getAllUsersTasksByProjectIdAndStatus(
			Authentication auth, Long projectId, TaskStatus status, int pageNo, int pageSize) {
		User user = (User) auth.getPrincipal();
		Long authUserId = user.getUserId();

		SuccessDataResult<TaskDtoPagedResponse> result = new SuccessDataResult<>(
				this.taskService.getAllUsersTasksByProjectIdAndStatus(authUserId, projectId, status, pageNo, pageSize),
				"Kullanıcının projedeki görevleri başarıyla getirildi ve filtrelendi.");
