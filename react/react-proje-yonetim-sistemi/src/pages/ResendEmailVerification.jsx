...
import { clearMessage, clearSuccessMessage, resendMailVerification } from '../redux/slices/userSlice';
...
function ResendEmailVerification() {
    ...
    const formik = useFormik({
        ...
        validationSchema,
        onSubmit: (values) => {
            dispatch(resendMailVerification({ email: values.email }));
        }
    });
        ...
        <Box sx={{ height: 'auto', display: 'flex', justifyContent: 'center', backgroundColor: '#f5f5f5' }}>
            ...
            <form onSubmit={formik.handleSubmit}>
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, width: { md: "400px", xs: "350px" }, padding: 4, borderRadius: 2, boxShadow: '0 4px 10px rgba(0,0,0,0.1)', backgroundColor: 'white' }}>
                    ...
                    <Typography variant="h5" textAlign="center" mb={2}>Hesabını Doğrula</Typography>
