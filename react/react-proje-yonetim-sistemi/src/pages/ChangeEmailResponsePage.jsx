...
import { verifyEmail, clearMessage, clearSuccessMessage, changeEmail, logOut } from '../redux/slices/userSlice';
import { Box, Typography, Alert, IconButton, CircularProgress } from '@mui/material';
import CloseIcon from '@mui/icons-material/Close';

function ChangeEmailAdressResponsePage() {
    ...
    return (
        <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', mt: 4, px: 2 }}>
            <Typography variant="h5" mb={2}>Email Değiştirme</Typography>
...
export default ChangeEmailAdressResponsePage;
